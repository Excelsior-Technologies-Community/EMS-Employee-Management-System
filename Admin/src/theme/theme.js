...
const theme = createTheme({
  ...
  components: {
    ...
    MuiCard: {
      styleOverrides: { root: { border: `1px solid ${colors.line}`, boxShadow: 'none' } },
    },
    MuiTableCell: {
      styleOverrides: { head: { fontWeight: 700, fontSize: 12.5, color: colors.inkSoft, textTransform: 'uppercase', letterSpacing: '0.03em' } },
    },
